...
public class WriteFileMethod {
	...
	public static boolean SaveToFile(InputStream is,String filePath,int bufferSize)
	throws IOException{
...
//			防盗链地址 Referer
	...
	public static void main(String[] args) throws IOException {
		String url = "http://m.12580.com/wap/image/search_indexlogo.gif" ;
		downFile(url,"e:/i.gif") ;
