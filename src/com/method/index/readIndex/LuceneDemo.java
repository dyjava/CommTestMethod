...
public class LuceneDemo {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		//create Lucene index
//		luceneDemo.createLuceneIndex(indexDirectory,dataDirectory);
...
//	private void createLuceneIndex(String indexDirectory0,String dataDirectory0) throws CorruptIndexException, IOException{
//		Indexer indexer = new Indexer(indexDirectory0,dataDirectory0);
//		//Create IndexWriter
...
//		Query query2 = new TermQuery(new Term("sender","smitha@careernet.com"));
		PrefixQuery query2 = new PrefixQuery(new Term("sender","job"));
	...
	private void queryResultsSortingExample(){
		Query query = new TermQuery(new Term("java", null));
	...
	void filterExample(){
		...
		try {
			...
			TopDocs topDocs = indexSearcher.search(query,prefixFilter, 20);
			printResults(topDocs);
